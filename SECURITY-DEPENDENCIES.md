...
Follow-up: upgraded development Vitest to 4.1.11, migrated its config to .mts, and expanded CI to audit development dependencies too. Full npm audit now reports zero findings. Runtime SDK support remains Node >=18; development tooling uses Node 22.
